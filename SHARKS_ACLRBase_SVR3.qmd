...
::: {#tbl-hypotheses}
| Type | Clinical | Statistical | Comments |
|----|----|----|----|
| Primary - Null |  | After adjusting for confounders, there is no difference in IKDC scores between our population and the published literature |  |
| Alternative | Patients with anterior cruciate ligament injuries presenting to QEII Hospital have baseline (IKDC) scores that differ significantly from those reported in the published literature, after adjusting for relevant patient and injury characteristics | After adjusting for confounders, there remains a significant difference in IKDC scores between our population and the published literature |  |
| Secondary - 1: Null |  |  |  |
| Alternative |  |  |  |
| Secondary - 1: Null |  |  |  |
| Alternative |  |  |  |
...
The second consideration for sample size is how many cases and studies may be required to develop a broader version of the model incorporating differences in regions and research methodology. This is difficult to estimate without making a number of assumptions based on limited information and may be best left to a point in the future when a clearer picture of all of the available literature is available.
...
Abstract submission for AOA ASM 2025 closed 4-May-2025. Consideration should be given for this project to presented at QLD AOA and AOA ASM in 2026.
...
|                     | Protocol preprint                                       |                                                                     |
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
|                     | Protocol registration                                   | ANZCTR                                                              |
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
|                     | Protocol journal publication                            |                                                                     |
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
| Data Collection     | Confirm reporting guidelines                            |                                                                     |
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
|                     | Conduct literature review and extraction                |                                                                     |
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
...
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
| Synthesis Reporting | Manuscript preparation                                  |                                                                     |
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
|                     | Reporting checklist                                     |                                                                     |
+---------------------+---------------------------------------------------------+---------------------------------------------------------------------+
...
+=================+======================================+===========================+=================================================+
| Lorenzo Calabro | Consultant Orthopaedic Surgeon       | Principal Investigator    | Direct supervision of SHOs                      |
+-----------------+--------------------------------------+---------------------------+-------------------------------------------------+
